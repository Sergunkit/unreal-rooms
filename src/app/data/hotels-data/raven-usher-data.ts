...
export const usherData = {
    ...
    image: headImage9,
    images: [headImage9, galleryUsher1_9, galleryUsher2_9, galleryUsher3_9, galleryUsher4_9, galleryUsher5_9],
    galleryActions: [
      {
        imageIndex: 0,
    ...
    amenities: {
      ...
      additionalServices: [
        ...
        { id: 'fitness', name: 'Индивидуальный фитнесс-тренинг', nameEn: 'Personal fitness training', price: 50 },
      ],
    },
    roomTypes: [
      { value: 'carl', label: 'Гостевая "Карл III"', labelEn: '"Charles III" Guest Room', basePrice: 85 },
      { value: 'napoleon', label: 'Комната "Наполеон"', labelEn: '"Napoleon" Room', basePrice: 90 },
      { value: 'tamerlan', label: 'Уютная студия "Тамерлан"', labelEn: '"Tamerlan" Studio', basePrice: 85 },
    ],
    mealTypes: [
      { value: 'breakfast', label: 'Только завтрак (включено)', labelEn: 'Breakfast only (included)', price: 0 },
      { value: 'full-dinner', label: 'Ужин от шеф-повара (TaVerna)', labelEn: 'Chef\'s Dinner (TaVerna)', price: 35 },
      { value: 'amontillado', label: 'Дегустация Амонтильядо в погребе', labelEn: 'Amontillado tasting', price: 60 },
    ],
    rooms: [
      {
        id: 1,
    ...
    feedBacks: [
      {
        ...
        textEn: 'I long to return; I cannot forget the warm, atmospheric evenings spent in the owner\'s company.',
      },
      {
        id: 2,
        author: 'Roderick_U',
