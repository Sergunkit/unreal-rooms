...
export const usherData: Hotel = {
  ...
  description:'Домашний уют или еда от шеф-повара? Интерьеры старинного замка или современный комфорт? Шум маскарадов или тишина кирпичных стен?  Никаких мук выбора! Незабываемый отдых и доступные цены! Мы предлагаем вам покинуть шумный центр города и окунуться в средневековую тишину на окраине Эдинбурга. Историческое здание, в котором находится наш гостевой дом с годами не претерпевало никаких существенных изменений. Поэтому вас ждет непревзойденная аутентичность и позитив) Изюминка это костюмированные вечеринки в средневековом стиле каждую пятницу. Наш гостевой дом ждет именно Вас!',
  ...
  location: 'Окраина Эдинбурга, рядом с заброшенным парком у озера',
  ...
  amenities: {
    ...
    additional: [
      ...
      'Карнавал каждую пятницу (есть прокат костюмов)',
